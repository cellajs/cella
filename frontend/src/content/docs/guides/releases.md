...
2. release-please keeps an open **release PR per package**, continuously updating the proposed version bump and generated [`cella/CHANGELOG.md`](https://github.com/cellajs/cella/blob/main/cella/CHANGELOG.md).
