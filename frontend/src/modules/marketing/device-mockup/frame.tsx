    ...
    case 'tablet':
      return (
        <div className="relative mx-auto border-gray-300 bg-gray-300 border-[.88rem] rounded-[2.5rem] aspect-[3/4]">
          ...
          <div className="rounded-8 bg-white dark:bg-gray-800 h-full w-full cursor-pointer">{inView && renderCarousel('rounded-[2rem]')}</div>
        </div>
      );
    case 'pc':
      return (
    ...
    case 'mobile':
      return (
        <div className="relative mx-auto border-gray-300 dark:border-gray-700 border-[.6rem] rounded-[1.5rem] h-[32rem] sm:h-[40rem] aspect-[9/16]">
          ...
          <div className="rounded-[1rem] h-full w-full bg-gray-200 dark:bg-gray-800 cursor-pointer">{inView && renderCarousel('rounded-[1rem]')}</div>
        </div>
      );
    default:
      return null;
