...
├── components/
│   ├── docs-layout.tsx          # Main layout (sidebar + content)
│   ├── docs-sidebar.tsx          # Navigation sidebar
│   ├── operation-table.tsx       # Table view using DataTable
│   ├── operation-columns.tsx     # Column definitions (see use-columns pattern)
│   ├── operation-row-details.tsx # Expandable row details (lazy loads from spec)
│   ├── schema-viewer.tsx         # Schema/model viewer
│   └── parameter-table.tsx       # Parameters display
├── hooks/
│   └── use-openapi-spec.ts      # Hook to access full spec for details
├── docs-page.tsx                 # Main route component
└── requirements.md               # This file

vite/
└── docs-plugin/                  # openapi-ts plugin
    ├── index.ts                  # Plugin export
    └── transform.ts              # Transform spec to lightweight operations array
```
