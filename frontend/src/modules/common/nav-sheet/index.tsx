...
const NavSheet = () => {
  ...
  } top-16 h-[calc(100%-16)] duration-300 ease-in-out p-0 md:left-16 md:top-0 z-[130] data-[state=closed]:duration-300 data-[state=open]:duration-300 overflow-hidden`;
