          ...
          <SheetContent className={`${existingSheet?.className ? existingSheet.className : sheet.className} items-start`}>
            {sheet.title && (
              <StickyBox className="z-10 flex items-center justify-between bg-background py-4">
                ...
                <SheetClose className="pr-1 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary">
