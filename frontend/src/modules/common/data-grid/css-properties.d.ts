...
declare module 'react' {
  interface CSSProperties {
    ...
    '--rdg-checkbox-disabled-border-color'?: string;
    '--rdg-checkbox-disabled-background-color'?: string;
    ...
    '--rdg-summary-row-height'?: string | number;
    '--rdg-summary-row-top'?: string;
    '--rdg-summary-row-bottom'?: string;
