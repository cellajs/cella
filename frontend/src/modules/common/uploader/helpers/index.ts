...
import { getUploadToken, GetUploadTokenData } from '~/openapi-client';
 ...
 */
export const createBaseTransloaditUppy = async (uppyOptions: CustomUppyOpt, tokenQuery: GetUploadTokenData['query']): Promise<CustomUppy> => {
  const uppy = new Uppy({
    ...uppyOptions,
