 ...
 * (e.g. an editor swapped for static text) cannot collapse and reflow the card. Stores only a
 ...
 * empty, so genuinely empty content settles to its natural size.
 */
export function PreserveHeight({ children }: { children: ReactNode }) {
