...
export const MenuSheetItem = ({ item, icon: Icon, className, searchResults }: MenuSheetItemProps) => {
  ...
  return (
    ...
    >
      ...
      <AvatarWrap
        className="z-1 items-center m-2 mx-3 group-hover/menuItem:font-bold group-data-[subitem=true]/menuItem:my-2 group-data-[subitem=true]/menuItem:mx-4 group-data-[subitem=true]/menuItem:text-xs h-8 w-8 group-data-[subitem=true]/menuItem:h-6 group-active/menuItem:translate-y-[.05rem] group-data-[subitem=true]/menuItem:w-6"
