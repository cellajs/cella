    ...
    <div className="relative h-10">
      ...
      <div className="flex items-center justify-between h-10">
        ...
        <div className="flex items-center gap-2 group/actions">
          ...
          <motion.div className="max-sm:hidden" animate={{ x: isSearchActive ? 48 : 0 }} transition={{ duration: 0.2 }}>
            <TooltipButton
          ...
          {user && (
            <Button
              ...
              variant="ghost"
              onClick={openAccount}
              className="hidden in-[.floating-nav]:inline-flex size-10"
            >
              <EntityAvatar
                className="size-7 border-[0.1rem] border-primary rounded-full"
                type="user"
                id={user.id}
                name={user.name}
          ...
          <motion.div
            ...
            className={isSearchActive ? 'pointer-events-none' : ''}
          >
            <TooltipButton toolTipContent={t('common:preferences')} side="right" sideOffset={22} disabled={!hasStarted}>
              <Button
                ref={preferencesRef}
                variant="ghost"
                size="icon"
