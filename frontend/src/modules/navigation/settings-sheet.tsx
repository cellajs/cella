...
export const SettingsSheet = () => {
  ...
  return (
    <div className="w-full py-3 px-3 min-h-[calc(100vh-0.5rem)] flex flex-col">
      ...
      {/* Menu settings */}
      <h3 className="text-sm font-medium text-muted-foreground/70 mb-2 px-3 lowercase">{t('common:menu')}</h3>
      ...
      {pwaEnabled && (
        <>
          <h3 className="text-sm font-medium text-muted-foreground/70 mb-3 px-3 lowercase">{t('common:offline')}</h3>
