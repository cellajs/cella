...
const BarNav = ({ triggerNavItem }: { triggerNavItem: TriggerNavItemFn }) => {
  ...
  return (
    <nav
      ...
      className="in-[.floating-nav]:hidden fixed z-100 sm:z-110 flex justify-between flex-col w-full max-sm:bottom-0 transition-transform ease-out shadow-xs sm:left-0 sm:top-0 sm:h-screen sm:w-16 group-[.focus-view]/body:hidden bg-primary data-[theme=none]:bg-secondary max-sm:data-[started=false]:translate-y-full sm:data-[started=false]:-translate-x-full"
    >
