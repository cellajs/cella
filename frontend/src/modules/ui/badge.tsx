...
const badgeVariants = cva(
  'inline-flex items-center justify-center border px-2 py-0.5 font-semibold transition-colors focus:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 shadow-xs',
  {
    variants: {
      variant: {
