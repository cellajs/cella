...
>(({ className, disabled, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      disabled
        ? ''
        : 'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-120 sm:grid place-items-center overflow-y-auto bg-background/40 backdrop-blur-xs',
      className,
    )}
    {...props}
  />
...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { container?: HTMLElement | null; hideClose?: boolean; containerOverlay?: boolean }
>(({ className, children, container, hideClose, id, containerOverlay, ...props }, ref) => {
  const renderContent = () => (
