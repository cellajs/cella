  ...
  ({ className, min, max, step, value, onValueChange, disabled, ...props }, ref) => {
    ...
    return (
      <div className={cn('relative flex w-full items-center', className)}>
        <input
          type="number"
          className="mr-2 flex h-10 w-full appearance-none rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-effect disabled:cursor-not-allowed disabled:opacity-50"
          value={value}
          onChange={(e) => {
