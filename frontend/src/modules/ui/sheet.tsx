...
function SheetContent({
  ...
  const content = (
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        !container &&
          'data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-114 transition data-[state=closed]:duration-300 data-[state=open]:duration-300',
        !container &&
          side === 'right' &&
  ...
  // Default: portal to body with overlay
  return (
    <SheetPortal>
      <SheetOverlay />
      {content}
