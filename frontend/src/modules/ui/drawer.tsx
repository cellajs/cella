...
function DrawerOverlay({ className, ...props }: DrawerPrimitive.Backdrop.Props & React.RefAttributes<HTMLDivElement>) {
  return (
    <DrawerPrimitive.Backdrop
      ...
      className={cn(
        'fixed inset-0 z-117 bg-black/50 transition-opacity transition-discrete duration-300',
...
function DrawerContent({
  ...
  children,
  ...props
}: DrawerPrimitive.Popup.Props & React.RefAttributes<HTMLDivElement>) {
  return (
    <DrawerPortal>
      <DrawerOverlay />
      <DrawerPrimitive.Viewport
        className={cn(
          'fixed inset-0 z-118 flex',
        ...
        >
          ...
          <div
            className={cn(
              ...
              'group-data-[swipe-direction=down]/drawer-content:py-3',
              'group-data-[swipe-direction=up]/drawer-content:order-last group-data-[swipe-direction=up]/drawer-content:py-3',
