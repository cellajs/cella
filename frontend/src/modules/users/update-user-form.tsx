            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 w-full">
                        ...
                        user.slug !== slug && (
                            <div className="absolute inset-y-1 right-1 flex justify-end">
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    aria-label="Revert to current user handle"
                                    onClick={revertSlug}
                                    className="h-full">
                                    <Undo size={16} className="mr-2" /> Revert to{" "}
                                    <strong className="ml-1">{user.slug}</strong>
                                </Button>
                            </div>
                        )
                    }
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    <Button
                        ...
                        variant="secondary"
                        onClick={cancel}
                        className={form.formState.isDirty ? "" : "sm:invisible"}>
                        {t("common:cancel")}
                    </Button>
                </div>
            </form>
