...
export const InvitedMembers = ({ entity }: InvitedMembersTableProps) => {
  ...
  return (
    <button
      ...
      className="flex max-sm:hidden rounded text-sm cursor-pointer ring-offset-background items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none"
    >
