 ...
 * {@link ApiError} and is explicitly excluded — those must fail fast so their
 ...
 *
 * This is not about retrying for its own sake — it exists so the retryer reaches a
 ...
 * boundary onlineManager has flipped offline and the mutation pauses instead of
