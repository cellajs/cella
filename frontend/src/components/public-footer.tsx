...
export const footerSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'Architecture', href: 'https://github.com/shareworks/cella/blob/development/info/ARCHITECTURE.md' },
      { title: 'Roadmap', href: 'https://github.com/shareworks/cella/blob/development/info/ROADMAP.md' },
    ],
  },
  {
    title: 'Connect',
  ...
  return (
    <div className="relative">
      ...
      <section className={sectionClass}>
        <div className="container flex max-w-[64rem] pt-8 flex-col items-center gap-4">
