...
export const zMenuSchema = z.object({
    organization: z.array(z.object({
        ...
        submenu: z.optional(z.array(z.union([
 ...
 */
export const zGetMyInvitationsResponse = z.array(z.object({
    entity: zContextEntityBaseSchema.and(z.object({
        organizationId: z.optional(z.string())
    })),
    invitedBy: z.union([
        z.object({
...
export const zCreateOrganizationResponse = zOrganization.and(z.object({
    membership: z.optional(z.object({
        id: z.string(),
        contextType: z.enum([
            'organization'
        ]),
 ...
 */
export const zResendInvitationResponse = z.void();
