 ...
 *
 * **GET /{orgId}/users** ·· [getUsers2](https://api.cellajs.com/docs#tag/users/get/{orgId}/users) ·· _users_
 *
 ...
 *
 * **GET /{orgId}/users/{idOrSlug}** ·· [getUser](https://api.cellajs.com/docs#tag/users/get/{orgId}/users/{idOrSlug}) ·· _users_
 *
