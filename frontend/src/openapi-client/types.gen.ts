...
export type CreateMembershipsData = {
    body?: {
        emails: Array<string>;
        role: 'member' | 'admin';
    };
...
export type CreateMembershipsErrors = {
    /**
     * Bad request: problem processing request.
     */
    400: {
...
export type CreateMembershipsError = CreateMembershipsErrors[keyof CreateMembershipsErrors];

export type CreateMembershipsResponses = {
    /**
     * Invitation was sent
     */
    200: boolean;
...
export type CreateMembershipsResponse = CreateMembershipsResponses[keyof CreateMembershipsResponses];
