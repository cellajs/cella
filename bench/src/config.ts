 ...
 */
import { TENANT_ID, ORG_ID, userId, userEmail, attachmentId } from './generators/ids';

export { TENANT_ID, ORG_ID, userId, userEmail, attachmentId };

export const BASE_URL = process.env.BASE_URL || 'http://localhost:4000';
export const SESSION_COOKIE_NAME = process.env.SESSION_COOKIE_NAME || 'cella-development-session-v1';
