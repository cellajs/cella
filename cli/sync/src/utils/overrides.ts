 ...
 */
export function isIgnored(filePath: string, config: CellaSyncConfig): boolean {
 ...
 */
export function isPinned(filePath: string, config: CellaSyncConfig): boolean {
...
): { isIgnored: boolean; isPinned: boolean } {
  return {
 ...
 */
export function findIgnoredFiles(files: string[], config: CellaSyncConfig): string[] {
 ...
 */
export function findPinnedFiles(files: string[], config: CellaSyncConfig): string[] {
