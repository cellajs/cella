...
export function handleUpdate(
  ...
  // getStxChangedFields returns null → WAL diff fallback only sees the embedding
  // column. User-driven edits always include 'updatedAt' in stx.changedFields
  // (set by buildStx), so they never match this suppression check.
