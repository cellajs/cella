...
// The pool is never opened: the test reads the options the CDC worker builds it with.
...
/** Imports the CDC worker's pool module afresh under `env` and returns the query logger option it passed. */
