 ...
 *
 * Only increments the top-level seq/mSeq column for catchup gap detection.
 * Per-entityType seq (counts['s:{entityType}']) is now managed by the
 * stamp_entity_seq_at database trigger on product entity tables.
 *
