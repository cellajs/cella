...
The documentation is generated from source code using \`zod\` schemas, converted into OpenAPI via \`zod-openapi\` and served through the \`hono\` framework.`,
  ...
  // errorTrackerDsn: 'https://0f6c6e4d1e825242d9d5b0b73faa97fa@o4506897995399168.ingest.us.sentry.io/4506898171559936', // SentryDSN
  errorTrackerDsn: 'https://883116961565407691b29a1622f73635@cellajs.bugsink.com/1', // BugsinkDSN
