...
/** The account the route addresses, for an organization admin: throws 403 without the role, 404 when it is not in the caller's tenant. */
export async function requireManagedServiceAccount(ctx: UserContext, id: string) {
