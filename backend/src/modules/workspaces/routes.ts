...
import { systemGuard, auth, setCtx, protect } from '../../middlewares/guard';
...
export const createWorkspaceRouteConfig = createRouteConfig({
  ...
  guard: [auth(), setCtx('workspace'), protect('create')],
  tags: ['workspaces'],
...
export const getWorkspaceByIdOrSlugRouteConfig = createRouteConfig({
  ...
  guard: [auth(), setCtx('workspace'), protect('read')],
  tags: ['workspaces'],
...
export const updateWorkspaceRouteConfig = createRouteConfig({
  method: 'put',
  path: '/workspaces/{workspace}',
  guard: [auth(), setCtx('workspace'), protect('update')],
  tags: ['workspaces'],
