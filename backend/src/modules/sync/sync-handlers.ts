...
import { routeToOrgSubscribers } from './stream-router';
import { type OrgStreamSubscriber, orgIndexKey } from './stream-types';
import syncRoutes from './sync-routes';

const syncRouteHandlers = new OpenAPIHono<Env>();
...
syncRouteHandlers.openapi(syncRoutes.stream, async (ctx) => {
...
export default syncRouteHandlers;
