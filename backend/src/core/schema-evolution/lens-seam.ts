...
/** Normalizes through the lens chain, retaining required rename twins during expand. */
...
/** Normalizes fields and timestamps through the lens chain, retaining required twins during expand. */
