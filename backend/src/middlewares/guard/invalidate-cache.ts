...
import { invalidateTokenGrantsByActor } from './token-grant-cache';
...
/** What one message drops: a user's sessions, memberships and access-token verdicts, an organization, or a tenant with its organizations. */
