...
/**
 * Checks if user has permission to create a product entity.
 *
 * This is separate from read/update/delete checks, since the entity may not exist yet.
 *
 * @param ctx - Request context.
 * @param entity - The product entity the user wants to create.
 * @returns Error object or `null` if no error occurred.
 */
export const canCreateEntity = <K extends ContextEntityType | ProductEntityType>(ctx: Context<Env>, entity: EntityModel<K>): ErrorType | null => {
