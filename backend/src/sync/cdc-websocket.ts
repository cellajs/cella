...
class CdcWebSocketServer {
  ...
  private handleMessage(data: string): void {
    try {
      ...
      } else if (message.cacheToken && message.activity.entityType && message.activity.entityId) {
        // Single entity: reserve cache token as before
        entityCache.reserve(message.cacheToken, message.activity.entityType, message.activity.entityId);
      }
