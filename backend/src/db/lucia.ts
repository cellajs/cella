...
export const githubAuth = new GitHub(env.GITHUB_CLIENT_ID || '', env.GITHUB_CLIENT_SECRET || '', {
  redirectURI: `${config.backendUrl}/authenticate${githubSignInCallbackRouteConfig.path}`,
});

export const googleAuth = new Google(
  env.GOOGLE_CLIENT_ID || '',
  env.GOOGLE_CLIENT_SECRET || '',
  `${config.backendUrl}/authenticate${googleSignInCallbackRouteConfig.path}`,
);
...
export const microsoftAuth = new MicrosoftEntraId(
  ...
  `${config.backendUrl}/authenticate${microsoftSignInCallbackRouteConfig.path}`,
);
