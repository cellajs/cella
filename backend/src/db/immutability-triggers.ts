...
/** Context entities (organizations, workspaces, projects) */
export const contextEntityImmutableColumns = BASE_ENTITY_COLUMNS;
...
/** Parentless product entities (pages) — same as context entities */
export const parentlessProductEntityImmutableColumns = BASE_ENTITY_COLUMNS;
...
/** Shared by context entities + parentless products (same column set) */
...
const baseEntityTables = [...contextEntityConfigs, ...parentlessProductConfigs];
