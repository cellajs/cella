...
export default defineConfig({
  ...
  // Keep pg-format external because its CJS dynamic data-file require does not survive ESM bundling.
  // The production dependency still ships for the embedded CDC worker.
