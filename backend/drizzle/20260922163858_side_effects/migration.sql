...
BEGIN
  ...
  BEGIN
    ...
    GRANT SELECT, INSERT, UPDATE, DELETE ON clients TO runtime_role;
...
BEGIN
  ...
  IF NOT has_table_privilege('runtime_role', 'public.clients', 'SELECT') THEN
    missing := array_append(missing, 'grant:clients:SELECT'); END IF;
  IF NOT has_table_privilege('runtime_role', 'public.clients', 'INSERT') THEN
    missing := array_append(missing, 'grant:clients:INSERT'); END IF;
  IF NOT has_table_privilege('runtime_role', 'public.clients', 'UPDATE') THEN
    missing := array_append(missing, 'grant:clients:UPDATE'); END IF;
  IF NOT has_table_privilege('runtime_role', 'public.clients', 'DELETE') THEN
    missing := array_append(missing, 'grant:clients:DELETE'); END IF;
