...
CREATE INDEX "activities_tx_id_index" ON "activities" USING btree ((tx->>'transactionId'));--> statement-breakpoint
CREATE INDEX "activities_tx_field_index" ON "activities" USING btree ("entity_type","entity_id",(tx->>'changedField'));--> statement-breakpoint
