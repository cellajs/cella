...
CREATE TABLE "inactive_memberships" (
	...
	"organization_id" uuid NOT NULL,
	CONSTRAINT "inactive_memberships_tenant_email_ctx" UNIQUE("tenant_id","email","channel_id")
);
--> statement-breakpoint
CREATE TABLE "memberships" (
	...
	"organization_id" uuid NOT NULL,
	CONSTRAINT "memberships_unique_channel" UNIQUE("tenant_id","user_id","channel_id")
);
--> statement-breakpoint
CREATE TABLE "organizations" (
	...
	"tenant_id" varchar(24) NOT NULL CONSTRAINT "organizations_tenant_id_key" UNIQUE,
...
CREATE TABLE "tenants" (
	...
	"restrictions" json DEFAULT '{"quotas":{"user":1000,"organization":5,"attachment":100},"rateLimits":{"apiPointsPerHour":1000}}' NOT NULL,
...
CREATE INDEX "sessions_user_id_device_id_hash_idx" ON "sessions" ("user_id","device_id_hash");--> statement-breakpoint
...
CREATE INDEX "memberships_channel_org_role_idx" ON "memberships" ("channel_type","organization_id","role");--> statement-breakpoint
