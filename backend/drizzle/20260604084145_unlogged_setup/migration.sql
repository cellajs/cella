...
BEGIN
  ...
  IF (SELECT relpersistence FROM pg_class WHERE relname = 'context_counters') != 'u' THEN
    ALTER TABLE context_counters SET UNLOGGED;
    RAISE NOTICE 'context_counters set to UNLOGGED';
  END IF;
