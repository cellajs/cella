 ...
 * (last update) keys are epoch-ms activity stamps and `hw:`/`hws:` keys are org-ledger
 * high-water marks (subtree/self), not deltas: they merge via GREATEST so the signal only
 * moves forward.
 */
