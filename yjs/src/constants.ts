...
export const YJS_SAVE_DEBOUNCE_MS = 3000; // Debounce rapid updates into a single save + materialization — also the freshness cadence of the entity's description/summary for non-editing viewers
