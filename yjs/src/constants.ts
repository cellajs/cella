export const YJS_CLEANUP_DELAY_MS = 5 * 60 * 1000; // Delay before cleaning up a disconnected document to allow quick reconnects without data loss
export const YJS_SAVE_DEBOUNCE_MS = 3000; // Debounce rapid updates into a single save to reduce backend load and improve performance
