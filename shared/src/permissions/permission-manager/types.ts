...
export interface PermissionCheckOptions {
  ...
  userId?: string;
  /**
   * Subject-level public read grants to evaluate. The `checkAccess` wrapper injects the
   ...
   *. The template behavior. Injected by the `checkAccess` wrapper like `publicGrants`.
   *
