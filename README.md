...
### API documentation
Cella uses [Scalar](https://scalar.com) for autogenerated [OpenAPI docs](https://cellajs.com/api/v1/docs).  Docs refresh on changes at [localhost:4000/docs](http://localhost:4000/docs)
